...
public class ModuleTypeReader : MewdekoTypeReader<ModuleInfo>
{
    ...
    public ModuleTypeReader(DiscordShardedClient client, CommandService cmds) : base(client, cmds) => _cmds = cmds;
...
public class ModuleOrCrTypeReader : MewdekoTypeReader<ModuleOrCrInfo>
{
    ...
    public ModuleOrCrTypeReader(DiscordShardedClient client, CommandService cmds) : base(client, cmds) => _cmds = cmds;
